...
Usage:
  probe:  python3 -m experiments.enumeration.enumerate_full_budget_swaps probe <depth>
  full:   python3 -m experiments.enumeration.enumerate_full_budget_swaps full <shard> <nshards>
