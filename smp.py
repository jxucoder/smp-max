"""Core tools for the maximum-stable-matchings project (f(5)=16 certification, f(6)=48?).

Conventions:
  - n men, n women, 0-indexed.
  - mpref[m] = tuple of women in m's preference order (best first).
  - wpref[w] = tuple of men in w's preference order (best first).
  - A matching mu is a tuple with mu[m] = w.
"""
