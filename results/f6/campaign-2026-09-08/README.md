...
The journal and historical logs are unchanged. Later identity and re-check
transcripts were carried forward from upstream commit `5e8cb3c`. Original paths and source
...
| [lean_identity.txt](lean_identity.txt) | Original full Lean formula and cube identity check |
| [recheck_2026-09-09.txt](recheck_2026-09-09.txt) | Second-machine 205-cube check; [journal](recheck_2026-09-09.jsonl) |
| [leanchecker_2026-09-09.txt](leanchecker_2026-09-09.txt) | Original replay of all 38 modules through the kernel |
...
The original certificates (about 25 TB total) were deleted after checking.
