...
formalized in Lean~4 in the accompanying development (nine files from
\texttt{SixBridge.lean} to \texttt{WRelabel6.lean}, $\sim$4{,}600 lines; no
\texttt{sorry}, axioms \texttt{propext}/\texttt{Classical.choice}/\texttt{Quot.sound}).
...
Lemma~\ref{lem:sym} concerns only the enumeration's internal symmetry reduction; its
relabelling half is proved at the instance level (\texttt{Sym6.lean}) and the rest is
validated computationally (canonicalization on/off agreement).
