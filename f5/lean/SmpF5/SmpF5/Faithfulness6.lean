...
* `exists_canonical_schedule` (the witness chain of plan §1/§3.4 and
  `PLAN.md` A): from `49 ≤ stableCount6 I` to a legal, first-appearance
...
/-! ## The witness chain (plan §1, §3.4; `PLAN.md` A) -/
...
/-- Plan §1/§3.4, `PLAN.md` A: every well-formed instance with at least 49
