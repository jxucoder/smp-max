...
Archived: every item is done; paths in the body refer to the tree before the 2026-09-09 restructure (`f5/lean/SmpF5/` is now `lean/SmpF5/`), see `docs/history/README.md`.
