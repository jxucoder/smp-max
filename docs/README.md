...
| Question | Read |
|---|---|
| What has been established? | [Results and evidence](results.md) |
| How can I check it myself? | [Verification](verification.md) |
| How does the argument work? | [Architecture](architecture.md) |
| Where do I start at a particular order? | [f(5)](f5.md), [f(6)](f6.md), [f(7)](f7.md) |
...
Current status belongs in the evidence ledger and roadmap. Historical
pages preserve the state at their recorded dates and are not setup guides.
