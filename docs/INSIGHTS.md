...
Retrospective. Publication state: `../PUBLISHING.md`; evidence: `../STATUS.md`.
...
2. **f(6) = 48, first determination (previously open; conjectured in
   ...
   (`../lean/SmpF5/SmpF5/Bridge6.lean`), whose only hypothesis — the
   ...
   corroboration. Numbers and cross-checks: `../STATUS.md`. Paper:
   `../f6/paper/f6.pdf`; working notes: `../f6/theory.pdf`.
...
- **f(7): the lower bound is cheap, the upper bound is not.** The
  ...
  (`../f7/README.md`), so cloud sizing was the wrong question. Meanwhile
  ...
  (`../f7/logs/`, 10 seeds) — odd orders live below full budget, exactly
...
What remains to do, in order, is `../STATUS.md` ("What is next"); the
publication steps are `../PUBLISHING.md`. The open mathematical questions
