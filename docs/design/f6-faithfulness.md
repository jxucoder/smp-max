...
- **2026-09-08 (step 0, 0', 9-def, 12; §11.1 resolved).** `SmpMax/Six/CampaignCubes.lean`
...
Exactly the f(5) base, item for item (`docs/verification.md` §"What you end up trusting"):
...
4. The DIMACS printer `ExportSixCnf.lean` (44 + 6 lines, read it) and the
   ...
   exactly as `results/f5/lean-cubes/verification.txt`. Reproduction: re-export every
