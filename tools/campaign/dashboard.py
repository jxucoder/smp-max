...
"""Live dashboard for the order-6 cube campaign.
    ...
    python3 -m tools.campaign.dashboard [--port 8765] [--journal campaign/campaign.jsonl]
...
from tools.campaign import cube_campaign as cc  # noqa: E402
...
def main():
    ...
    ap.add_argument("--journal", default=os.path.join(cc.RUNS, "campaign.jsonl"))
    ap.add_argument("--scratch", default=os.path.join(cc.RUNS, "scratch"))
    ap.add_argument("--log", default=os.path.join(cc.RUNS, "campaign.log"))
